...
export default function RegisterPage() {
  return (
    <main className="flex-1 flex items-center justify-center min-h-[calc(100vh-80px)] bg-surface-soft p-4 py-12">
        <div className="bg-canvas w-full max-w-3xl p-8 rounded-[32px] shadow-[0_16px_32px_rgba(0,0,0,0.1)] text-center">
          ...
          <div className="border-t border-hairline mt-6 pt-6">
            <Link href="/login" className="text-body-strong text-ink hover:underline">
